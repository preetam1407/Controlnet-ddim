...
class SimpleNet(nn.Module):
    def __init__(
        ...
        ######## TODO ########
        # Build a sequence of TimeLinear layers to predict noise at each timestep.
        # Each layer connects the dimensions specified by dim_in, dim_hids, and dim_out.
    ...
    def forward(self, x: torch.Tensor, t: torch.Tensor):
        ...
        """
        ######## TODO ########
        # Pass the noisy input x through the network.
        # Apply TimeLinear at each layer, using ReLU activation at last.
        h = x
